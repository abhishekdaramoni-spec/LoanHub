...
def verify_email(token):
    ...
    if user:
        ...
        create_notification(user.id, "Your email address has been verified. Welcome to LoanSphere!")
    else:
...
def reset_password(token):
    ...
    if form.validate_on_submit():
        ...
        create_notification(user.id, "Your account password was successfully updated.")
        return redirect(url_for('auth.login'))
...
def profile():
    ...
    if form.validate_on_submit():
        ...
        create_notification(current_user.id, "Your profile details were updated.")
